...
foreach ($arResult['PRODUCTS'] as $productId => $arItems)
{
	...
	//mycode - вставляем "Доступное кол-во" в поле при выборе текущего поля в фильтре для отображения
    $gridDataRecord['columns']['AVAILABLE_QUANTUTY_99999'] = getProductAvailableQuantityById($arItems['ID']);
    //mycode - вставляем "Доступное кол-во" в поле при выборе текущего поля в фильтре для отображения
