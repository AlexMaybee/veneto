...
if (is_array($arResult['HEADERS']))
{
	...
	//mycode - добавляем свой
    $newHeaders[] = [
        'id' => 'AVAILABLE_QUANTUTY_99999',
        'sort' => 'AVAILABLE_QUANTUTY_99999',
...
//mycode - функция для получения значения "Доступное количество"
function getProductAvailableQuantityById($productId){
    $IBLOCK_ID = 20;
