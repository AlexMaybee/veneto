...
//mycode
/**********************************************/
//аякс при добавлении нового товара в список во вкладке "товары", вызывается в 597й строке (пока)
function callAjaxForProperty(productID) {
    //console.log(productID);
    var server = '/local/lib/product_store_add_value/ajax/handler.php';
    $.ajax({
        url: server,
        type: "POST",
        data: {'productId' : productID, 'action' : 'GIVE_ME_PRODUCT_STORE_DATA'},
        dataType: "json",
